                        ...
                        items: [
                            {
                                ...
                                id: "activeTimers",
                                items: [
                                    { text: "commit", isEnabled: plugin.settings.autoSaveInterval > 0 },
                                    { text: "push", isEnabled: settingsTab.isAutoPushEnabled() },
                                    { text: "pull", isEnabled: plugin.settings.autoPullInterval > 0 },
                                ],
                            },
                            {
                                type: "Toggle",
                                path: "differentIntervalCommitAndPush",
                                postSave: () => plugin.automaticsManager.reload("commit", "push"),
                            },
                            {
                                type: "Numberfield",
                                path: "autoSaveInterval",
                                constraint: intervalConstraint,
                                replacements: settingsTab.autoSaveIntervalReplacements,
                            },
                            {
                                type: "RadioGroup",
                            ...
                            },
                            {
                                ...
                                constraint: intervalConstraint,
                                showIf: plugin.settings.differentIntervalCommitAndPush,
                            },
                            {
                                type: "Numberfield",
                            ...
                            },
                            {
                                ...
                                showIf: !plugin.settings.customMessageOnAutoBackup,
                            },
                        ],
                    },
                    // Commit Message
                    {
                        ...
                        items: [
                            ...
                            },
                            {
                                ...
                                onClick: () => settingsTab.onClickPreviewCommitMessage(),
                            },
                            {
                                type: "Textfield",
                            ...
                            },
                            {
                                ...
                                handler: {
                                    getValue: () => plugin.localStorage.getHostname() ?? "",
                                    setValue: (value) => plugin.localStorage.setHostname(value),
                                },
                            },
                            {
                                type: "Toggle",
                        ...
                        items: [
                            {
                                type: "Dropdown",
                                path: "syncMethod",
                                items: [{ id: "merge" }, { id: "rebase" }, { id: "reset" }],
                            },
                            {
                                type: "Toggle",
                                path: "autoPullOnBoot",
                        ...
                        items: [
                            {
                                ...
                                preSave: (value) => settingsTab.setLineAuthor(value),
                            },
                            {
                                type: "Conditional",
                                showIf: plugin.settings.lineAuthor.show === true,
                                items: [
                                    {
                                        type: "Dropdown",
                                        path: "lineAuthor.followMovement",
                                        items: [{ id: "inactive" }, { id: "same-commit" }, { id: "all-commits" }],
                                    },
                                    {
                                        type: "Toggle",
                                    ...
                                    },
                                    {
                                        ...
                                        replacements: settingsTab.customLineAuthorDatetimeFormatPreview,
                                    },
                                    {
                                        type: "Dropdown",
                                    ...
                                    },
                                    {
                                        ...
                                        replacements: settingsTab.coloringMaxAgeReplacements,
                                        validate: (value: string) => settingsTab.validateColoringMaxAge(value),
                                    },
                                    {
                                        type: "ColorPicker",
                                        path: "lineAuthor.colorNew",
                                        datatype: "RGB",
                                        preview: () => settingsTab.previewColor("colorNew"),
                                    },
                                    {
                                        type: "ColorPicker",
                                        path: "lineAuthor.colorOld",
                                        datatype: "RGB",
                                        preview: () => settingsTab.previewColor("colorOld"),
                                    },
                                    {
                                        type: "ColorDropdown",
                                        ...
                                        postSave: () => settingsTab.updateColors(),
                                    },
                                    {
                                        type: "Toggle",
                ...
                items: [
                    {
                        ...
                        items: [
                            ...
                            },
                            {
                                ...
                                id: "customGitPath",
                                handler: {
                                    getValue: () => plugin.localStorage.getGitPath() ?? "",
                                    setValue: (value: string) => settingsTab.setGitPath(value),
                                },
                            },
                            {
                                type: "Textarea",
                                id: "envVariables",
                                handler: {
                                    getValue: () => plugin.localStorage.getEnvVars().join("\n"),
                                    setValue: (value: string) => plugin.localStorage.setEnvVars(value.split("\n")),
                                },
                            },
                            {
                                type: "Textarea",
                                id: "pathVariables",
                                handler: {
                                    getValue: () => plugin.localStorage.getPATHPaths().join("\n"),
                                    setValue: (value: string) => plugin.localStorage.setPATHPaths(value.split("\n")),
                                },
                            },
                            {
                                type: "Button",
                                id: "reloadGit",
                                onClick: async () => await (plugin.gitManager as SimpleGit).setGitInstance(),
                            },
                        ],
                    },
                    {
                        ...
                        handler: {
                            ...
                            setValue: (value: string) => settingsTab.setBasePath(value),
                        },
                    },
                    {
                        type: "Textfield",
                    ...
                    },
                    {
                        ...
                        id: "disablePlugin",
                        handler: {
                            getValue: () => plugin.localStorage.getPluginDisabled(),
                            setValue: (value: boolean) => settingsTab.setPluginDisabled(value),
                        },
                    },
                ],
            },
